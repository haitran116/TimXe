...
public class menu_tim_vitri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_tim_vitri);
        ...
        listView = (ListView) findViewById(R.id.id_list_tim_vitri);

        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mh = new Intent(menu_tim_vitri.this,MainActivity.class);
                startActivity(mh);
            }
        });
    ...
    public void timkiemtheodieukien(){
        ...
        imageButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editText.getText().toString().trim() != null){
                    TextView bkq = (TextView) findViewById(R.id.txt_bangketqua);
                    Nha_Xe_Tim = new String[400][6];
                    String Tu_Khoa = editText.getText().toString().toLowerCase().trim();
                    int m=0;
                    for(int i=0;i<=n;i++){
                        if(diemden[i].toLowerCase().trim().matches(".*"+Tu_Khoa+".*")
                                || diqua[i].toLowerCase().trim().matches(".*"+Tu_Khoa+".*")
                                    || diemdi[i].toLowerCase().trim().matches(".*"+Tu_Khoa+".*")){
                    ...
                    if(m != 0){
                        ...
                        bkq.setText("Bảng kết quả");
                        bkq.setTextColor(R.color.colorAccent);

                        MyAdapter adt = new MyAdapter(menu_tim_vitri.this,tnhaxe,sdt,gxb,diem_di,diem_den,m);
                        listView.setAdapter(adt);
                    }else {
                        bkq.setText("");
                        listView.setAdapter(null);
                        Toast.makeText(menu_tim_vitri.this, "Không có kết quả", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(menu_tim_vitri.this, "Nhập từ khóa", Toast.LENGTH_SHORT).show();
                }
            }
        });
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                final Dialog dialogt = new Dialog(menu_tim_vitri.this);
                ...
                goi.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(ActivityCompat.checkSelfPermission(menu_tim_vitri.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                            ActivityCompat.requestPermissions(menu_tim_vitri.this,new String[]{android.Manifest.permission.CALL_PHONE},1);
                        }
                        else {
